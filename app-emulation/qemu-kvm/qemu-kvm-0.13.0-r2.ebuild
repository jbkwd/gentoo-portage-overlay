...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/qemu-kvm/qemu-kvm-0.13.0-r2.ebuild,v 1.4 2011/01/17 18:56:42 anarchy Exp $
...
png pulseaudio qemu-ifup sasl sdl ssl static vde pcidebug"
...
#		"${FILESDIR}/${PN}-guest-hang-on-usb-add.patch"
	if use pcidebug; then
		epatch "${FILESDIR}/qemu-0.13.0-pcidebug.patch"
	fi
}
